...
zSystems Panel is an open-source, web-based application designed for easy management of game servers.
...
Fly High, Game On: zSystems's pledge for unrivaled game servers.

## Links

* [Website](https://pelican.dev)
* [Docs](https://panel.zhw1nq.dev/docs)
* [Discord](https://discord.gg/pelican-panel)
* [Wings](https://github.com/pelican-dev/wings)

## Supported Games and Servers

zSystems supports a wide variety of games by utilizing Docker containers to isolate each instance.
