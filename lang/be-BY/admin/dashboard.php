...
return [
    'heading' => 'Сардэчна запрашаем у zSystems!',
...
',
        ...
        'intro-first-node' => [
            ...
            'button_label' => 'Стварыце першы вузел у zSystems',
        ],
        'intro-support' => [
            'heading' => 'Падтрымка zSystems',
            'content' => 'Дзякуй за выкарыстанне zSystems! Гэта стала магчымым толькі дзякуючы падтрымцы вас, нашых удзельнікаў і ўсіх астатніх, хто нас падтрымлівае!',
