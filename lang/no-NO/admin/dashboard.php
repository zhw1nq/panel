...
return [
    'heading' => 'Velkommen til zSystems!',
    ...
    'sections' => [
        ...
        'intro-first-node' => [
            ...
            'extra_note' => 'Hvis du støter på problemer, vennligst rapporter dem på GitHub.',
            'button_label' => 'Opprett første node i zSystems',
        ],
        'intro-support' => [
            'heading' => 'Støtt zSystems',
            'content' => 'Takk for at du bruker zSystems! Dette har kun vært mulig gjennom støtten fra deg, våre bidragsytere og resten av våre støttespillere!',
